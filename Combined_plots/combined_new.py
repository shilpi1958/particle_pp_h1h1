...
h14_l1.SetXTitle("M_h2 [GeV]")
h14_l1.SetYTitle("Events")
h14_l1.SetLineColor(6)
h14_l2.SetXTitle("M_h2[GeV]")
...
h4_l1.SetXTitle("p_{T#gamma} [GeV]")
h4_l1.SetYTitle("Events")
h4_l1.SetLineColor(6)
h4_l2.SetXTitle("p_{T#gamma}[GeV]")
...
h5_l1.SetXTitle("#p_{T}(b)[GeV]")
h5_l1.SetYTitle("Events")
h5_l1.SetLineColor(6)
h5_l2.SetXTitle("#p_{T}(b)[GeV]")
...
h6_l1.SetXTitle("#p_{T}(b~) [GeV]")
h6_l1.SetYTitle("Events")
h6_l1.SetLineColor(6)
h6_l2.SetXTitle("#p_{T}(b~) [GeV]")
...
h4_l2.SetLineColor(4)
h4_l1.Draw("hist")
h4_l2.Draw("hist&SAMES")
legend.Draw()
c.SaveAs("pT_combine_gamma_log.png")
c.SaveAs("pT_combine_gamma_log.root")
