...
#H2_400GeV
runs=['04' , '05', '06']
leg_entry=['M_{H2}=400, M_{H3}=600','M_{H2}=400, M_{H3}=800', 'M_{H2}=400, M_{H3}=1000']
...
for i in runs:
    ...
    h_m_H1=TH1F('run_'+i,"H3(1MeV)",1000,350,450)
...
legend.Draw()
c.SaveAs("h2_400_CombinedMassGamma.png")
c.SaveAs("h2_400_h2_400_CombinedMassGamma.root")
...
legend.Draw()
c.SaveAs("h2_400_CombinedMassbb~.png")
c.SaveAs("h2_400_CombinedMassbb~.root")
...
legend.Draw()
c.SaveAs("h2_400_CombinedPhi_b.png")
c.SaveAs("h2_400_CombinedPhi_b.root")
...
legend.Draw()
c.SaveAs("h2_400_CombinedEta_b.png")
c.SaveAs("h2_400_CombinedEta_b.root")
...
legend.Draw()
c.SaveAs("h2_400_Combined_pT_b.png")
c.SaveAs("h2_400_Combined_pT_b.root")
...
c.SaveAs("h2_400_CombinedPhi_bbar.png")
c.SaveAs("h2_400_CombinedPhi_bbar.root")
...
c.SaveAs("h2_400_CombinedEta_bbar.png")
c.SaveAs("h2_400_CombinedEta_bbar.root")
...
legend.Draw()
c.SaveAs("h2_400_Combined_pT_bbar.png")
c.SaveAs("h2_400_Combined_pT_bbar.root")
...
c.SaveAs("h2_400_CombinedPhi_a.png")
c.SaveAs("h2_400_CombinedPhi_a.root")
...
legend.Draw()
c.SaveAs("h2_400_CombinedEta_a.png")
c.SaveAs("h2_400_CombinedEta_a.root")
...
c.SaveAs("h2_400_Combined_pT_a.png")
c.SaveAs("h2_400_Combined_pT_a.root")
