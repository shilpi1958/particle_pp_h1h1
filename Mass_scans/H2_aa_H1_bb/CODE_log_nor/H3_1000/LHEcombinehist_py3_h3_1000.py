...
#H3_1000GeV
runs=['03' , '06', '09', '12']
leg_entry=['M_{H2}=200, M_{H3}=1000','M_{H2}=400, M_{H3}=1000','M_{H2}=600, M_{H3}=1000','M_{H2}=800, M_{H3}=1000']
...
for i in runs:
    ...
    h_m_H1=TH1F('run_'+i,"H3(1MeV)",1000,0,1000)
    h_m_H2=TH1F('run_'+i,"H3(1MeV)",100,100,150)
...
legend.Draw()
c.SaveAs("h3_1000_CombinedMassGamma.png")
c.SaveAs("h3_1000_CombinedMassGamma.root")
...
legend.Draw()
c.SaveAs("h3_1000_CombinedMassbb~.png")
c.SaveAs("h3_1000_CombinedMassbb~.root")
...
legend.Draw()
c.SaveAs("h3_1000_CombinedPhi_b.png")
c.SaveAs("h3_1000_CombinedPhi_b.root")
...
legend.Draw()
c.SaveAs("h3_1000_CombinedEta_b.png")
c.SaveAs("h3_1000_CombinedEta_b.root")
...
legend.Draw()
c.SaveAs("h3_1000_Combined_pT_b.png")
c.SaveAs("h3_1000_Combined_pT_b.root")
...
c.SaveAs("h3_1000_CombinedPhi_bbar.png")
c.SaveAs("h3_1000_CombinedPhi_bbar.root")
...
c.SaveAs("h3_1000_CombinedEta_bbar.png")
c.SaveAs("h3_1000_CombinedEta_bbar.root")
...
legend.Draw()
c.SaveAs("h3_1000_Combined_pT_bbar.png")
c.SaveAs("h3_1000_Combined_pT_bbar.root")
...
c.SaveAs("h3_1000_CombinedPhi_a.png")
c.SaveAs("h3_1000_CombinedPhi_a.root")
...
legend.Draw()
c.SaveAs("h3_1000_CombinedEta_a.png")
c.SaveAs("h3_1000_CombinedEta_a.root")
...
c.SaveAs("h3_1000_Combined_pT_a.png")
c.SaveAs("h3_1000_Combined_pT_a.root")
