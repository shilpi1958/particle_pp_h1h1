...
dt.SetTitle("Cross-Sections for H3 -> H2 (#gamma #gamma) H1 (b b~) ; M_{H2} [GeV] ; Cross-Sections [pb")
dt.SetLineColor(2)
dt.SetLineWidth(4)
dt.Draw("ACP*")
...
dt1.SetTitle("Cross-Sections for H3 -> H2 (#gamma #gamma) H1 (b b~) ; M_{H2} [GeV] ; Cross-Sections [pb")
dt1.SetLineColor(3)
dt1.SetLineWidth(4)
dt1.Draw("CP*")
...
dt2.SetTitle("Cross-Sections for H3 -> H2 (#gamma #gamma) H1 (b b~) ; M_{H2} [GeV] ; Cross-Sections [pb")
dt2.SetLineColor(4)
dt2.SetLineWidth(4)
dt2.Draw("CP*")
