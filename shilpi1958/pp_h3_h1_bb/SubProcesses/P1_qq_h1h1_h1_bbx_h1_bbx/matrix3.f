...
C     ----------
     ...
     $   , ZERO)
      ...
      CALL FFS3_4_3(W(1,4),W(1,3),GC_374,GC_333,MDL_MH1, FK_MDL_WH1
     $ ,W(1,5))
     ...
     $ ,W(1,6))
      CALL FFS3_4_3(W(1,1),W(1,2),GC_424,GC_253,MDL_MH3, FK_MDL_WH3
     $ ,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL SSS1_0(W(1,5),W(1,6),W(1,3),GC_524,AMP(1))
