...
C     
C     Process: u u~ > h2 > h1 h1 WEIGHTED<=4 @1
C     Process: u c~ > h2 > h1 h1 WEIGHTED<=4 @1
C     Process: c u~ > h2 > h1 h1 WEIGHTED<=4 @1
C     Process: c c~ > h2 > h1 h1 WEIGHTED<=4 @1
C     Process: d d~ > h2 > h1 h1 WEIGHTED<=4 @1
C     Process: d s~ > h2 > h1 h1 WEIGHTED<=4 @1
C     Process: s d~ > h2 > h1 h1 WEIGHTED<=4 @1
C     Process: s s~ > h2 > h1 h1 WEIGHTED<=4 @1
C     
...
C       Flip CM_RAP (to get rapidity right)
      ...
      IF (PASSCUTS(P1)) THEN
        IF(IPROC.EQ.1) DSIGPROC=DSIG1(P1,WGT,IMODE)  ! u u~ > h1 h1
        IF(IPROC.EQ.2) DSIGPROC=DSIG2(P1,WGT,IMODE)  ! u c~ > h1 h1
        IF(IPROC.EQ.3) DSIGPROC=DSIG3(P1,WGT,IMODE)  ! c u~ > h1 h1
        IF(IPROC.EQ.4) DSIGPROC=DSIG4(P1,WGT,IMODE)  ! c c~ > h1 h1
        IF(IPROC.EQ.5) DSIGPROC=DSIG5(P1,WGT,IMODE)  ! d d~ > h1 h1
        IF(IPROC.EQ.6) DSIGPROC=DSIG6(P1,WGT,IMODE)  ! d s~ > h1 h1
        IF(IPROC.EQ.7) DSIGPROC=DSIG7(P1,WGT,IMODE)  ! s d~ > h1 h1
        IF(IPROC.EQ.8) DSIGPROC=DSIG8(P1,WGT,IMODE)  ! s s~ > h1 h1
      ENDIF
