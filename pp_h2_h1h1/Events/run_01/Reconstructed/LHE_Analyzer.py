...
h_ptb=TH1F("pT of h2 ","",100,0,100)
for i in pt_b:
        h_ptb.Fill(i)

h_etab=TH1F("Eta of h2 ","",10,-5,5)
for i in eta_b:
        h_etab.Fill(i)

h_ptbbar=TH1F("pT of h2 ","",100,0,1000)
for i in pt_bbar:
       h_ptbbar.Fill(i)

h_etabbar=TH1F("Eta of h2 ","",10,-5,5)
for i in eta_bbar:
       h_etabbar.Fill(i)

h1_m_H=TH1F("Mass of h2","",100,250,300)
for i in m_H:
        h1_m_H.Fill(i)

h_phi_b=TH1F("Phi of h2 ","",10,-5,5)
for i in phi_b:
        h_phi_b.Fill(i)

h_phi_bbar=TH1F("Phi of h2 ","",10,-5,5)
for i in phi_bbar:
        h_phi_bbar.Fill(i)
...
c.SaveAs("DR.png")
'''
h_ptb.SetXTitle("pT of h2 ")
h_ptb.SetYTitle("Events")
h_ptb.Draw()
cmsname.Draw()
c.SaveAs("pt_h2_reconstructed.png")

h_etab.SetXTitle("Eta of h2 ")
h_etab.SetYTitle("Events")
h_etab.Draw()
cmsname.Draw()
c.SaveAs("eta_h2_reconstructed.png")
'''
...
h_etabbar.SetXTitle("Eta of h2 ")
h_etabbar.SetYTitle("Events")
h_etabbar.Draw()
cmsname.Draw()
c.SaveAs("etabbar.png")
'''
h1_m_H.SetXTitle("Mass of h2")
h1_m_H.SetYTitle("Events")
h1_m_H.Draw()
cmsname.Draw()
c.SaveAs("mass_h2_reconstructed.png")

h_phi_b.SetXTitle("Phi of h2 ")
h_phi_b.SetYTitle("Phi of h2 ")
h_phi_b.Draw()
cmsname.Draw()
c.SaveAs("Phi_h2_reconstructed .png")
'''
