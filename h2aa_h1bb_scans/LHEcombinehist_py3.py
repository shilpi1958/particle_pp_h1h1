...
runs=['01' ,'02','03','04','05','06','07','08' , '09', '12']
...
for i in runs:
    ...
    #mass=[]
    h_m_H1=TH1F('run_'+i,"",10000,0,1000)
    h_m_H2=TH1F('run_'+i,"",10000,100,150)

    h_b_pT=TH1F('run_'+i,"",1000,0,1000)
    h_b_eta=TH1F('run_'+i,"",10000,-5,5)
    h_b_phi=TH1F('run_'+i,"",10,-4,4)

    h_bbar_pT=TH1F('run_'+i,"",1000,0,1000)
    h_bbar_eta=TH1F('run_'+i,"",10000,-5,5)
    h_bbar_phi=TH1F('run_'+i,"",10,-4,4)

    h_a_pT=TH1F('run_'+i,"", 1000,0,1000)
    h_a_eta=TH1F('run_'+i,"",10000,-5,5)
    ...
    for mass in bbar_phi:
            h_bbar_phi.Fill(mass)
...
for hist in range(len(hists5)):
    print(hist)
    if hist==0:
        hists3[hist].SetXTitle("p_{T}(b)[GeV]")
        hists3[hist].SetYTitle("Events")
        hists3[hist].SetLineColor(hist+1)
        #hists[hist].SetLineWidth(3)
        #hists[hist].SetMaximum(2)
        ...
        hists2[hist].SetXTitle("p_{T}(b)[GeV]")
        hists2[hist].SetYTitle("Events")
        hists2[hist].SetLineColor(hist+1)
        #hists[hist].SetLineWidth(3)
        #hists[hist].SetMaximum(2)
...
for hist in range(len(hists6)):
    print(hist)
    if hist==0:
        hists3[hist].SetXTitle("#phi_(bbar)")
        hists3[hist].SetYTitle("Events")
        hists3[hist].SetLineColor(hist+1)
        #hists[hist].SetLineWidth(3)
        #hists[hist].SetMaximum(2)
        ...
        hists4[hist].SetXTitle("#phi_(bbar)")
        hists4[hist].SetYTitle("Events")
        hists4[hist].SetLineColor(hist+1)
        #hists[hist].SetLineWidth(3)
        #hists[hist].SetMaximum(2)
...
for hist in range(len(hists7)):
    print(hist)
    if hist==0:
        hists4[hist].SetXTitle("#eta_(bbar)")
        hists4[hist].SetYTitle("Events")
        hists4[hist].SetLineColor(hist+1)
        #hists[hist].SetLineWidth(3)
        #hists[hist].SetMaximum(2)
...
for hist in range(len(hists8)):
    print(hist)
    if hist==0:
        hists3[hist].SetXTitle("p_{T}(bbar)[GeV]")
        hists3[hist].SetYTitle("Events")
        hists3[hist].SetLineColor(hist+1)
        #hists[hist].SetLineWidth(3)
        #hists[hist].SetMaximum(2)
        ...
        hists2[hist].SetXTitle("p_{T}(bbar)[GeV]")
        hists2[hist].SetYTitle("Events")
        hists2[hist].SetLineColor(hist+1)
        #hists[hist].SetLineWidth(3)
        #hists[hist].SetMaximum(2)
...
for hist in range(len(hists11)):
    print(hist)
    if hist==0:
        hists3[hist].SetXTitle("p_{T}(a)[GeV]")
        hists3[hist].SetYTitle("Events")
        hists3[hist].SetLineColor(hist+1)
        #hists[hist].SetLineWidth(3)
        #hists[hist].SetMaximum(2)
        ...
        hists2[hist].SetXTitle("p_{T}(a)[GeV]")
        hists2[hist].SetYTitle("Events")
        hists2[hist].SetLineColor(hist+1)
        #hists[hist].SetLineWidth(3)
        #hists[hist].SetMaximum(2)
