...
C     
C     Process: u u~ > h3 WEIGHTED<=2 @1
C     *   Decay: h3 > h2 h1 WEIGHTED<=2
C     *     Decay: h2 > a a WEIGHTED<=2
C     *     Decay: h1 > b b~ WEIGHTED<=2
C     Process: u c~ > h3 WEIGHTED<=2 @1
C     *   Decay: h3 > h2 h1 WEIGHTED<=2
C     *     Decay: h2 > a a WEIGHTED<=2
C     *     Decay: h1 > b b~ WEIGHTED<=2
C     Process: c u~ > h3 WEIGHTED<=2 @1
C     *   Decay: h3 > h2 h1 WEIGHTED<=2
C     *     Decay: h2 > a a WEIGHTED<=2
C     *     Decay: h1 > b b~ WEIGHTED<=2
C     Process: c c~ > h3 WEIGHTED<=2 @1
C     *   Decay: h3 > h2 h1 WEIGHTED<=2
C     *     Decay: h2 > a a WEIGHTED<=2
C     *     Decay: h1 > b b~ WEIGHTED<=2
C     Process: d d~ > h3 WEIGHTED<=2 @1
C     *   Decay: h3 > h2 h1 WEIGHTED<=2
C     *     Decay: h2 > a a WEIGHTED<=2
C     *     Decay: h1 > b b~ WEIGHTED<=2
C     Process: d s~ > h3 WEIGHTED<=2 @1
C     *   Decay: h3 > h2 h1 WEIGHTED<=2
C     *     Decay: h2 > a a WEIGHTED<=2
C     *     Decay: h1 > b b~ WEIGHTED<=2
C     Process: s d~ > h3 WEIGHTED<=2 @1
C     *   Decay: h3 > h2 h1 WEIGHTED<=2
C     *     Decay: h2 > a a WEIGHTED<=2
C     *     Decay: h1 > b b~ WEIGHTED<=2
C     Process: s s~ > h3 WEIGHTED<=2 @1
C     *   Decay: h3 > h2 h1 WEIGHTED<=2
C     *     Decay: h2 > a a WEIGHTED<=2
C     *     Decay: h1 > b b~ WEIGHTED<=2
C     
...
C       Flip CM_RAP (to get rapidity right)
      ...
      IF (PASSCUTS(P1)) THEN
        IF(IPROC.EQ.1) DSIGPROC=DSIG1(P1,WGT,IMODE)  ! u u~ > a a b b~
        IF(IPROC.EQ.2) DSIGPROC=DSIG2(P1,WGT,IMODE)  ! u c~ > a a b b~
        IF(IPROC.EQ.3) DSIGPROC=DSIG3(P1,WGT,IMODE)  ! c u~ > a a b b~
        IF(IPROC.EQ.4) DSIGPROC=DSIG4(P1,WGT,IMODE)  ! c c~ > a a b b~
        IF(IPROC.EQ.5) DSIGPROC=DSIG5(P1,WGT,IMODE)  ! d d~ > a a b b~
        IF(IPROC.EQ.6) DSIGPROC=DSIG6(P1,WGT,IMODE)  ! d s~ > a a b b~
        IF(IPROC.EQ.7) DSIGPROC=DSIG7(P1,WGT,IMODE)  ! s d~ > a a b b~
        IF(IPROC.EQ.8) DSIGPROC=DSIG8(P1,WGT,IMODE)  ! s s~ > a a b b~
      ENDIF
