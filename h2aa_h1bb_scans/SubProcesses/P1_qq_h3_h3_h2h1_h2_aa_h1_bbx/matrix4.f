...
C     ----------
      IF (FIRST) THEN
        FIRST=.FALSE.
        FK_MDL_WH3 = SIGN(MAX(ABS(MDL_WH3), ABS(MDL_MH3
     $   *SMALL_WIDTH_TREATMENT)), MDL_WH3)
     ...
     $   , ZERO)
      ...
      CALL VVS1_3(W(1,3),W(1,4),GC_321,MDL_MH2, FK_MDL_WH2,W(1,5))
      CALL OXXXXX(P(0,5),MDL_MB,NHEL(5),+1*IC(5),W(1,4))
      CALL IXXXXX(P(0,6),MDL_MB,NHEL(6),-1*IC(6),W(1,3))
      CALL FFS3_4_3(W(1,3),W(1,4),GC_374,GC_333,MDL_MH1, FK_MDL_WH1
     $ ,W(1,6))
      CALL SSS1_3(W(1,6),W(1,5),GC_525,MDL_MH3, FK_MDL_WH3,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL FFS3_4_0(W(1,1),W(1,2),W(1,3),GC_427,GC_256,AMP(1))
