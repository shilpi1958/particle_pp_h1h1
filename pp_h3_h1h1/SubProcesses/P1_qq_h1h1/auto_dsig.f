...
C     
C     Process: u u~ > h3 > h1 h1 WEIGHTED<=4 @1
C     Process: u c~ > h3 > h1 h1 WEIGHTED<=4 @1
C     Process: c u~ > h3 > h1 h1 WEIGHTED<=4 @1
C     Process: c c~ > h3 > h1 h1 WEIGHTED<=4 @1
C     Process: d d~ > h3 > h1 h1 WEIGHTED<=4 @1
C     Process: d s~ > h3 > h1 h1 WEIGHTED<=4 @1
C     Process: s d~ > h3 > h1 h1 WEIGHTED<=4 @1
C     Process: s s~ > h3 > h1 h1 WEIGHTED<=4 @1
C     
